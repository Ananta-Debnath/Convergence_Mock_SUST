...
describe("routing & severity rules", () => {
    ...
    it("contested refund (scam mention) → dispute_resolution + high", () => {
        const r = classifyAndRoute("Please refund my last transaction, I think I was scammed", "en");
    ...
    it("wrong_transfer with amount ≥ 10000 bumps severity", () => {
        const r = classifyAndRoute("I sent 15000 taka to the wrong number this morning", "en");
